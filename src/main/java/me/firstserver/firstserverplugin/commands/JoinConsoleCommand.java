...
public class JoinConsoleCommand implements CommandExecutor {
        ...
        if (sender instanceof Player){
            ...
            if (args.length == 0){
                ...
                if (target == null){
                    ...
                    target.sendMessage(ChatColor.GREEN + "Xfirst_playerX joined the console. You can chat with him now!");
